...
const USER_CONFIG = {
  ...
  pdfFiles: {
    ...
    4: { 0: "emf1/emf-total.pdf", 
         1: "emf1/STUCOR_EC3452-EJ complete document.pdf",
         2:"emf1/unit-1.pdf",
         3:"unit-5.pdf",
...
function showWelcome() {
  ...
  if (panel)
    panel.innerHTML = `<br><br><div class="welcome"><div class="vault-3d"><div class="vault-cube"><div class="face front">📚</div><div class="face back">🏆</div><div class="face left">🎓</div><div class="face right">📒</div><div class="face top">📋</div><div class="face bottom">📖</div></div></div><br><h2>Welcome to Study Vault</h2><p>Tap a subject below to get started.</p><div class="key-pill">🔑 Passwords: Contact</div><div style="display:flex;gap:10px;margin-top:5px;flex-wrap:wrap;justify-content:center;"><a class="key-pill" style="text-decoration:none;" href="https://wa.me/916379075447" target="_blank">Seshan: 6379075447</a><a class="key-pill" style="text-decoration:none;" href="https://wa.me/916383340975" target="_blank"">Vidhya: 6383340975</a> <br> <p class="key-pill" style="text-decoration:none;">M4 : m4passv</p><br> <p class="key-pill" style="text-decoration:none;">MPMC : mpmcpassss</p><br><p class="key-pill" style="text-decoration:none;">AC : acpassg</p><br> <p class="key-pill" style="text-decoration:none;">EMF : emfpassi</p><br><p class="key-pill" style="text-decoration:none;">EVS : evspasst</p><br><p class="key-pill" style="text-decoration:none;">LIC : licpassn</p><br> <p class="key-pill" style="text-decoration:none;">OLD QP : oldqppassd</p><br><a href="https://sem-5-vault.vercel.app/" class="key-pill" style="text-decoration:none;cursor:pointer">Click to Get Next Semester Notes..<a/>  </div></div>`;
}
